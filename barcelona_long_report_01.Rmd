...
Here I explore the Barcelona data that has three types of crimes: property vehicle, property personal and violence collected in surveys and official data over regions (73) and time (6 years). We group years by two in order to avoid having regions with 0s. 
...
summary(qs_m1[[1]], standardized = T)
```

### Property personal

```{r}
summary(qs_m1[[2]], standardized = T)
```
