...
corr_data %>%
  ...
  mutate(group = case_when(
    str_detect(key, "\\.r\\.w") ~ "Survey victims",
    str_detect(key, "\\.p\\.w") ~ "Survey reported",
    str_detect(key, "\\.f\\.w") ~ "Survey places",
    str_detect(key, "\\.rp\\.w") ~ "Survey victims reported",
    TRUE ~ "Police"
...
model <- c("t_viol =~ 1*viol.f.wo + 1*viol.p.wo + 1*viol.r.wo + 1*viol.rp.wo
            ...
            viol.p.wo + prop_vh.p.wo + prop_pers.p.wo + viol.r.wo + prop_vh.r.wo + prop_pers.r.wo + viol.f.wo + prop_vh.f.wo + prop_pers.f.wo + viol.rp.wo + prop_vh.rp.wo + prop_pers.rp.wo ~ 0*1
...
model <- c("t1 =~ 1*prop_vh.f.wo_15 + 1*prop_vh.p.wo_15 + 1*prop_vh.r.wo_15 + 1*prop_vh.rp.wo_15
            ...
            prop_vh.p.wo_15 + prop_vh.p.wo_17 + prop_vh.p.wo_19 + prop_vh.r.wo_15 + prop_vh.r.wo_17 + prop_vh.r.wo_19 + prop_vh.f.wo_15 + prop_vh.f.wo_17 + prop_vh.f.wo_19 + prop_vh.rp.wo_15 + prop_vh.rp.wo_17 + prop_vh.rp.wo_19 ~ 0*1
...
model <- c("t1 =~ 1*prop_pers.f.wo_15 + 1*prop_pers.p.wo_15 + 1*prop_pers.r.wo_15 + 1*prop_pers.rp.wo_15
            ...
            prop_pers.p.wo_15 + prop_pers.p.wo_17 + prop_pers.p.wo_19 + prop_pers.r.wo_15 + prop_pers.r.wo_17 + prop_pers.r.wo_19 + prop_pers.f.wo_15 + prop_pers.f.wo_17 + prop_pers.f.wo_19 + prop_pers.rp.wo_15 + prop_pers.rp.wo_17 + prop_pers.rp.wo_19 ~ 0*1
...
model <- c("t1 =~ 1*viol.f.wo_15 + 1*viol.p.wo_15 + 1*viol.r.wo_15 + 1*viol.rp.wo_15
            ...
            viol.p.wo_15 + viol.p.wo_17 + viol.p.wo_19 + viol.r.wo_15 + viol.r.wo_17 + viol.r.wo_19 + viol.f.wo_15 + viol.f.wo_17 + viol.f.wo_19 + viol.rp.wo_15 + viol.rp.wo_17 + viol.rp.wo_19 ~ 0*1
...
qs_rel_wo %>%
  ...
  mutate(group = case_when(str_detect(key, "\\.r\\.") ~ "Survey victim",
                           ...
                           str_detect(key, "\\.rp") ~ "Survey victims reported",
                           TRUE ~ "Police"),
